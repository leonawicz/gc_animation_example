...
Here I share <iframe style="float: right; padding-left: 10px; padding-right: 10px" width="560" height="315" src="https://www.youtube.com/embed/uQYR91qixgo" frameborder="0" allowfullscreen></iframe> R code I used to produce <a href="https://www.youtube.com/embed/uQYR91qixgo">animated great circle arcs</a> on top of a rotating 3D Earth.
...
where the coordinates in row describe a subsequent point along one of my paths.
